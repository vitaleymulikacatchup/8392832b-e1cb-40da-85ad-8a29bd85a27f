...
export const metadata: Metadata = {
  title: "Aesthetic Medical Center | Cosmetic Surgery & Injectables",
  description: "Board-certified plastic surgeons offering Botox, fillers, facelifts, and rhinoplasty. See real patient transformations and book your consultation today.",
  keywords: "plastic surgery, cosmetic procedures, Botox, dermal fillers, facelift, rhinoplasty, aesthetic medicine",
  robots: {
    index: true,
    follow: true,
  },
  openGraph: {
    title: "Aesthetic Medical Center | Transform Your Look",
    description: "Expert cosmetic and plastic surgery with board-certified surgeons. Beautiful, natural-looking results.",
    siteName: "Aesthetic Medical Center",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1763566545476-fx0aihtv.jpg",
        alt: "Cosmetic transformation results",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "Aesthetic Medical Center | Cosmetic Surgery",
    description: "Transform your look with our expert plastic surgeons",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1763566545476-fx0aihtv.jpg"],
  },
};
